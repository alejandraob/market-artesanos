    ...
    <div class="flex flex-col">
      ...
      <div class="bg-amber-50 border border-amber-200 rounded-2xl p-5 mt-4">
        <div class="flex items-start gap-4">
          ...
          <div>
            <p class="font-bold text-amber-800 text-sm">Tiempo de elaboracion y envio</p>
            <p class="text-amber-700 text-sm mt-1">Una vez efectuada la compra, el producto sera elaborado y enviado en un plazo de <strong>15 a 20 dias habiles</strong>. El costo de envio se calcula en el carrito al finalizar la compra.</p>
          </div>
        </div>
      </div>
    </div>
...
const activeImage = ref('/placeholder.svg')
