  ...
  <div v-else class="grid grid-cols-1 md:grid-cols-2 gap-12">
    ...
    <div class="flex flex-col">
      ...
      <div class="flex items-center gap-3 mt-6">
        ...
        <a :href="`https://wa.me/?text=${encodeURIComponent(product.name + ' - ' + shareUrl)}`" target="_blank" class="w-9 h-9 bg-green-100 rounded-lg flex items-center justify-center hover:bg-green-200 transition-colors">
        ...
        <a :href="`https://www.facebook.com/sharer/sharer.php?u=${encodeURIComponent(shareUrl)}`" target="_blank" class="w-9 h-9 bg-blue-100 rounded-lg flex items-center justify-center hover:bg-blue-200 transition-colors">
