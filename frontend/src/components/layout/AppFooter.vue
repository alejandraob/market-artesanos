  ...
  <footer class="bg-artisan-dark text-white border-t-8 border-artisan-accent pt-16 pb-10">
    <div class="max-w-7xl mx-auto px-4">
      ...
      <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10 mb-12">
        ...
        <div class="sm:col-span-2 lg:col-span-2">
          ...
          <ul class="space-y-3 text-gray-300 text-sm">
            ...
            <li class="flex items-center gap-2">
              <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 text-artisan-accent shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" /></svg>
              <a href="mailto:asociaciondeartesanosdecatriel@gmail.com" class="hover:text-white transition-colors">asociaciondeartesanosdecatriel@gmail.com</a>
            </li>
            <li class="flex items-center gap-2">
              ...
              <a href="https://www.instagram.com/asociacionartesanoscatriel" target="_blank" class="hover:text-white transition-colors">@asociacionartesanoscatriel</a>
            </li>
          </ul>
        </div>
      </div>
      ...
      <div class="pt-8 border-t border-white/10 text-center text-gray-500 text-sm">
        <p>&copy; {{ new Date().getFullYear() }} Asociacion de Artesanos de Catriel. Tradicion y Calidad.</p>
      </div>
    </div>
  </footer>
</template>
